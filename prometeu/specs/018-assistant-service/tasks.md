...
| T4 | fallback matcher, help text, month-over-month and balance narratives through the engine | FR-01807, FR-01808, FR-01809, FR-01810 | `src/server/llm/fallbacks.ts`, `src/server/llm/fallbacks.test.ts` | FR-01807, FR-01808, FR-01809, FR-01810 golden tests | T1 | P | Q1 |
